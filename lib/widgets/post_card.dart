            ...
            alignment: Alignment.center,
              children: [
                ...
                AnimatedOpacity(
                  ...
                  child: LikeAnimation(child: const Icon(Icons.favorite, color: Colors.white, size: 170,), isAnimating: isLikeAnimating, duration:const Duration(milliseconds: 400),onEnd: (){
                    setState(() {
